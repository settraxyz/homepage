    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <div className="bg-blue-200/10 -mt-20 pt-20 relative">
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          <motion.div
            className="absolute -left-80 -top-50 h-[24rem] w-[36rem] rounded-full bg-gradient-to-br from-indigo-200/80 to-purple-200/60 blur-3xl"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.6, 0.8, 0.6],
              rotate: [0, 360],
          ...
          />
          <motion.div
            className="absolute -right-40 top-3/4 h-[20rem] w-[32rem] rounded-full bg-gradient-to-tr from-cyan-300/80 to-emerald-200/30 blur-3xl"
            animate={{
              scale: [1, 1.05, 1],
              opacity: [0.4, 0.7, 0.4],
              rotate: [360, 0],
